...
public class SignupSuccessDialog extends Dialog implements OnClickListener {

    private DialogCallBack dialogcallback;
    private DisplayMetrics dm;


    public SignupSuccessDialog(Context context, DialogCallBack dialogcallback) {
        super(context, R.style.CustomDialog_discovery);
        this.dialogcallback = dialogcallback;
    }

    public SignupSuccessDialog(Context context, int themeId) {
