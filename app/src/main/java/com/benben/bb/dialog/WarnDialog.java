...
public class WarnDialog extends Dialog implements OnClickListener {
    ...
    public WarnDialog(Context context, String warn, DialogCallBack dialogcallback) {
    ...
    public WarnDialog(Context context, String warn, String ok, String cancle, DialogCallBack dialogcallback) {
        super(context, R.style.CustomDialog_warn);
        this.context = context;
        this.warn = warn;
        this.ok = ok;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int width = (int) (MyApplication.screenWidthPixels * 0.9);
