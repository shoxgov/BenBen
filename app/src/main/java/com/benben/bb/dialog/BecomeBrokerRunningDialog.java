...
public class BecomeBrokerRunningDialog extends Dialog implements OnClickListener {
    ...
    public BecomeBrokerRunningDialog(Context context, int themeId) {
