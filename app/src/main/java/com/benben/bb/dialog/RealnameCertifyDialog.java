...
public class RealnameCertifyDialog extends Dialog implements OnClickListener {
    ...
    public RealnameCertifyDialog(Context context, int themeId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_realname_certify);
