...
public class BecomeEnterpriseDialog extends Dialog implements OnClickListener {
    ...
    public BecomeEnterpriseDialog(Context context, DialogCallBack dialogcallback) {
        this(context, R.style.CustomDialog_discovery);
        this.dialogcallback = dialogcallback;
    }
    public BecomeEnterpriseDialog(Context context, String info, DialogCallBack dialogcallback) {
        this(context, R.style.CustomDialog_discovery);
        this.dialogcallback = dialogcallback;
        this.info = info;
    }

    public BecomeEnterpriseDialog(Context context, int themeId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_become_enterprise);
