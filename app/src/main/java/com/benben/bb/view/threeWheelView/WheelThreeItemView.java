...
package com.benben.bb.view.threeWheelView;
...
import com.benben.bb.view.threeWheelView.adapter.WheelViewAdapter;
import com.benben.bb.view.threeWheelView.listener.OnWheelChangedListener;
import com.benben.bb.view.threeWheelView.listener.OnWheelClickedListener;
import com.benben.bb.view.threeWheelView.listener.OnWheelScrollListener;
 ...
 */
public class WheelThreeItemView extends View {
	 ...
	 * Constructor
	 */
	public WheelThreeItemView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelThreeItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheelThreeItemView(Context context) {
		super(context);
		initData(context);
	}
