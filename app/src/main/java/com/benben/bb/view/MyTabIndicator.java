...
public class MyTabIndicator extends HorizontalScrollView {
     ...
     * 指示器的宽度为单个Tab的1/3
     */
    private static float RADIO_TRIANGEL = 1.0f / 2;
    /**
     * ViewPager
     */
    ...
    public MyTabIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            INDICATORCOLOR = typedArray.getColor(R.styleable.MyTabIndicator_tabIndicatorColor, 0xFFFFFFFF);
            INDICATORWIDTH = typedArray.getDimension(R.styleable.MyTabIndicator_tabIndicatorWidth, 0);
            typedArray.recycle();
        } else {
    ...
    private class TabLayout extends LinearLayout {
        ...
        public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            mPaintIndicator.setStrokeWidth(Utils.dip2px(context, 2));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float y1, y2;
            y1 = y2 = getHeight() - Utils.dip2px(getContext(), 7);
