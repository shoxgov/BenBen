...
public class EnterpriseEmployeeEntryedFragment extends BaseFragment {
    ...
    public EnterpriseEmployeeEntryedFragment() {
        LogUtil.d("TestFragment non-parameter constructor");
    }

    public static EnterpriseEmployeeEntryedFragment newInstance(String arg) {
        Bundle bundle = new Bundle();
        bundle.putString(ARG, arg);
        EnterpriseEmployeeEntryedFragment fragment = new EnterpriseEmployeeEntryedFragment();
    ...
    CustomBaseQuickAdapter.QuickXCallBack callBack = new CustomBaseQuickAdapter.QuickXCallBack() {
        ...
        public void convert(BaseViewHolder baseViewHolder, Object itemModel) {
            ...
            baseViewHolder.setText(R.id.employ_entry_btn1, "辞退");
