...
//        imm.hideSoftInputFromWindow(EditText.getWindowToken(), 0);
     ...
     * 要转换的地址或者字符串,可以是中文
     */
    public static Bitmap createQRImageByPhoto(Context context, String url, String saveFileName) throws Exception {
        Bitmap bmp = null;
        try {
            // 判断URL的合法性
     ...
     * @param bitmap
     */
    public static void saveCode(Bitmap bitmap, String saveFileName) {
        // 创建文件夹
//        String fileName = "myShareCode.jpg";
    ...
    private static final String[] PERMISSION_EXTERNAL = new String[]{
    ...
    public static void verifyStoragePermissions(Activity activity) {
        ...
        if (permissionWrite != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(activity, PERMISSION_EXTERNAL,
